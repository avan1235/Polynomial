...
public final class Interpreter {
    public static final void run(String args) throws Exception {
        String program = args;

        JavaCompiler compiler = ToolProvider.getSystemJavaCompiler();

        JavaFileObject compilationUnit =
                new StringJavaFileObject("Interpreter", program);
        ...
        Class<?> codeGenTest = classLoader.loadClass("Interpreter");
